CREATE TABLE IF NOT EXISTS `easytrainer_log`.`log_modality_content` (
  ...
  `log_modality_main_type_id` INT NOT NULL,
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_log_type_content_copy1_log_modality_main1_idx` (`log_modality_main_type_id` ASC) VISIBLE,
  CONSTRAINT `fk_log_type_content_copy1_log_modality_main1`
    FOREIGN KEY (`log_modality_main_type_id`)
